    ...
    for prompt, answers in prompts_and_answers:
        ...
        for ans in answers:
            ...
            for k, step in enumerate(ans_list):
                ...
                step_conversations.append(list(current_conversation))
...
if __name__ == "__main__":
    ...
    process_and_select_answers('results_1/aime24/no_thinking_r1/temp_0.6/Pass_at_16/DeepSeek-R1-Distill-Qwen-32B_s0_e-1.json', model, tokenizer, candidate_tokens)